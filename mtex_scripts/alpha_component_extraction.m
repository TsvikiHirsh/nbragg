...
%% Make base odf
pf = loadPoleFigure_beartex("RPV_alpha.xpc")
CS=pf.CS; SS=pf.SS;
...
hh=figure; plotPDF(odf_ini,h_plot,'upper','minmax','figsize','tiny','projection','earea','contourf','colorRange',[0.5,1.5])
...
hh=figure; plotPDF(odfc,h_plot,'upper','minmax','figsize','tiny','projection','earea','contourf','colorRange',[0.5,1.5])
...
%% Export for ncrystal
f = fopen("alpha_components.csv",'w')
